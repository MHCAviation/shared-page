...
var f = b9(), C9 = Object.defineProperty, x9 = Object.defineProperties, L9 = Object.getOwnPropertyDescriptors, P2 = Object.getOwnPropertySymbols, d0 = Object.prototype.hasOwnProperty, f0 = Object.prototype.propertyIsEnumerable, c3 = (t, e, n) => e in t ? C9(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, o1 = (t, e) => {
  for (var n in e || (e = {})) d0.call(e, n) && c3(t, n, e[n]);
  if (P2) for (var n of P2(e)) f0.call(e, n) && c3(t, n, e[n]);
  return t;
}, v1 = (t, e) => x9(t, L9(e)), m0 = (t, e) => {
  var n = {};
  for (var o in t) d0.call(t, o) && e.indexOf(o) < 0 && (n[o] = t[o]);
  if (t != null && P2) for (var o of P2(t)) e.indexOf(o) < 0 && f0.call(t, o) && (n[o] = t[o]);
  return n;
  ...
  return function(n = {}) {
    ...
    var t2 = (r, a) => Object.defineProperty(a, "name", { value: r }), S3 = (r, a, s) => {
      ...
      if (i.hasOwnProperty(r)) {
        ...
        if (S3(i, r, r), i[r].Ha.hasOwnProperty(s)) throw new B(`Cannot register multiple overloads of a function with the same number of arguments (${s})!`);
        i[r].Ha[s] = a;
      } else i[r] = a, i[r].Qa = s;
    }, G0 = (r) => {
    ...
    var R3 = (r) => {
      ...
      var s = B1[r];
      if (s === void 0) throw r = `${a} has unknown type ${j3(r)}`, new B(r);
      return s;
    }, K2 = (r) => {
      ...
      if (s <<= 1, 32 < s - r && T3) return T3.decode(j.subarray(r, s));
      for (s = "", l = 0; !(l >= a / 2); ++l) {
        var c = N[r + 2 * l >> 1];
        if (c == 0) break;
    ...
    L3 = N3, B = i.BindingError = class extends Error {
      constructor(r) {
...
` + l.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var g4 = { c: (r, a, s, l) => y1(`Assertion failed: ${r ? X(j, r) : ""}, at: ` + [a ? a ? X(j, a) : "" : "unknown filename", s, l ? l ? X(j, l) : "" : "unknown function"]), d: () => $2(), p: (r, a, s) => {
      ...
      q2(w1, function() {
        ...
        t1 = t2(T, function(...n3) {
          ...
          if (H3 === void 0) throw new B(`Tried to invoke ctor of ${T} with invalid number of parameters (${n3.length}) - expected (${Object.keys(b1.Oa).toString()}) parameters instead!`);
        ...
        return n1 = new n2(T, b1, !0, !1, !1), o2 = new n2(T + "*", b1, !1, !1, !1), k1 = new n2(T + " const*", b1, !1, !0, !1), E3[r] = { pointerType: o2, bb: k1 }, M3(w1, t1), [n1, o2, k1];
      });
    }, t: (r, a, s, l, c, y) => {
      var k = B2(a, s);
      c = c1(l, c), N1([], [r], (w) => {
      ...
      a = i1(a), a = R3(a), y = c1(c, y), N1([], [r], (M) => {
        ...
        return w1 === void 0 || w1.Ha === void 0 && w1.className !== M.name && w1.Qa === s - 2 ? (T.Qa = s - 2, T.className = M.name, G[a] = T) : (S3(G, a, q), G[a].Ha[s - 2] = T), N1([], S, (t1) => (t1 = H2(q, t1, M, y, k), G[a].Ha === void 0 ? (t1.Qa = s - 2, G[a] = t1) : G[a].Ha[s - 2] = t1, [])), [];
      });
    }, $: (r) => L1(r, D3), B: (r, a, s, l) => {
      function c() {
      }
      ...
      }, a - 1), N1([], k, (w) => (M3(r, H2(r, [w[0], null].concat(w.slice(1)), null, c, y), a - 1), []));
    }, o: (r, a, s, l, c) => {
      ...
      return D[l >> 2] = c, 0;
    }, j: x4, f: S4, e: E4, _: _4, s: M4, C: I4, u: C4, b: y4, a: w4, i: b4, l: k4, q: L4, G: P4, X: O3, N: (r, a) => ($3(j.subarray(r, r + a)), 0) }, Q = function() {
      var r;
      function a(l) {
        var c;
    ...
    }(), t3 = (r) => (t3 = Q.ka)(r), W3 = (r) => (W3 = Q.la)(r), R1 = (r) => (R1 = Q.ma)(r), U3 = (r, a) => (U3 = Q.oa)(r, a), f1 = (r, a) => (f1 = Q.pa)(r, a), a2 = (r) => (a2 = Q.qa)(r), m1 = (r) => (m1 = Q.ra)(r), p1 = () => (p1 = Q.sa)(), q3 = (r, a, s) => (q3 = Q.ta)(r, a, s);
    ...
    var z3 = i.dynCall_vijjjj = (r, a, s, l, c, y, k, w, S, M) => (z3 = i.dynCall_vijjjj = Q.xa)(r, a, s, l, c, y, k, w, S, M);
...
W(j2, "_ModulePromise", null), W(j2, "_wasmURL", `https://cdn.jsdelivr.net/npm/${v0}@${p0}/dist/dotlottie-player.wasm`);
var g0 = class {
  constructor() {
...
var a3 = (t, e) => t === "reverse" ? e.Mode.Reverse : t === "bounce" ? e.Mode.Bounce : t === "reverse-bounce" ? e.Mode.ReverseBounce : e.Mode.Forward, T9 = (t, e) => t === "contain" ? e.Fit.Contain : t === "cover" ? e.Fit.Cover : t === "fill" ? e.Fit.Fill : t === "fit-height" ? e.Fit.FitHeight : t === "fit-width" ? e.Fit.FitWidth : e.Fit.None, F9 = (t, e) => {
  ...
  _fetchData(e) {
    return z(this, null, function* () {
      ...
      return Y3(o) ? o : new TextDecoder().decode(o);
    });
  }
  _loadFromData(e) {
  ...
  setRenderConfig(e) {
    let n = e, { devicePixelRatio: o, freezeOnOffscreen: i } = n, u = m0(n, ["devicePixelRatio", "freezeOnOffscreen"]);
...
var e0 = class H1 {
  ...
  _create(e) {
    return z(this, null, function* () {
      ...
      let { instanceId: i } = yield this._sendMessage("create", o1({ instanceId: this._id, config: v1(o1({}, e), { canvas: o }) }, X3(this._canvas, ((n = e.renderConfig) == null ? void 0 : n.devicePixelRatio) || V1())), [o]);
  ...
  _sendMessage(e, n, o) {
    return z(this, null, function* () {
      let i = { id: `dotlottie-request-${Z3()}`, method: e, params: n };
...
W(e0, "_workerManager", new N9()), W(e0, "_wasmUrl", "");
...
}, w0 = ({ items: t }) => /* @__PURE__ */ f.jsx("nav", { "aria-label": "breadcrumb", style: { margin: "16px 0" }, children: /* @__PURE__ */ f.jsx(
  "ol",
  {
    style: {
      display: "flex",
    ...
    children: t.map((e, n) => /* @__PURE__ */ f.jsxs("li", { style: { display: "flex", alignItems: "center" }, children: [
      n > 0 && /* @__PURE__ */ f.jsx("span", { style: { margin: "0 8px" }, children: "/" }),
      n < t.length - 1 ? /* @__PURE__ */ f.jsx(
        "a",
        {
          href: e.to,
      ...
      ) : /* @__PURE__ */ f.jsx("span", { style: { color: "#111" }, children: e.label })
    ] }, e.to))
  }
) }), Q9 = [
  {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ f.jsxs("div", { className: V.faqContent, children: [
          /* @__PURE__ */ f.jsx("div", { className: V.breadcrumbs, children: x && /* @__PURE__ */ f.jsx(w0, { items: x }) }),
...
}, e6 = "url('https://images.unsplash.com/photo-1507812984078-917a274065be?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0')", t6 = "Advice and answers from the team", n6 = "Guides to configuring and using the platform, troubleshooting common issues, and more.", r6 = () => /* @__PURE__ */ f.jsxs(
  "svg",
  {
    width: "32",
    height: "32",
      ...
      "div",
      {
        ...
        children: u ? /* @__PURE__ */ f.jsx("div", { children: "Loading..." }) : p.map((C) => /* @__PURE__ */ f.jsxs(
          "div",
          {
            ...
            onClick: () => b(C.title),
            children: [
              /* @__PURE__ */ f.jsx("div", { style: { marginBottom: 16 }, children: /* @__PURE__ */ f.jsx(r6, {}) }),
...
function a6() {
  if (t0) return u2;
  t0 = 1, Object.defineProperty(u2, "__esModule", { value: !0 }), u2.parse = m, u2.serialize = p;
...
var s6 = /^:[\w-]+$/, l6 = 3, u6 = 2, c6 = 1, h6 = 10, d6 = -2, n0 = (t) => t === "*";
function f6(t, e) {
  let n = t.split("/"), o = n.length;
  return n.some(n0) && (o += d6), e && (o += u6), n.filter((i) => !n0(i)).reduce(
    (i, u) => i + (s6.test(u) ? l6 : u === "" ? c6 : h6),
    o
  );
}
function m6(t, e) {
...
function k0(t, e, n, o = !1) {
  ...
  let v = y6(i, h), p = m && m !== "/" && m.endsWith("/"), x = (u || m === ".") && n.endsWith("/");
...
function j6() {
  let t = W6(), e = L6(t) ? `${t.status} ${t.statusText}` : t instanceof Error ? t.message : JSON.stringify(t), n = t instanceof Error ? t.stack : null, o = "rgba(200,200,200, 0.5)", i = { padding: "0.5rem", backgroundColor: o }, u = { padding: "2px 4px", backgroundColor: o }, m = null;
...
function F6(t, e = [], n = null, o = null) {
  ...
  return i.reduceRight((v, p, x) => {
    ...
    n && (b = u && p.route.id ? u[p.route.id] : void 0, C = p.route.errorElement || R6, m && (h < 0 && x === 0 ? (P0(
      "route-fallback",
      !1,
...
function K6(t, e) {
  ...
  if (B6(t)) {
    ...
    if (o = v ? U1(v, e) : null, n = t.getAttribute("formmethod") || h.getAttribute("method") || E2, i = l3(t.getAttribute("formenctype")) || l3(h.getAttribute("enctype")) || S2, u = new FormData(h, t), !J6()) {
...
async function Z6(t, e, n) {
  ...
  return r5(
    o.flat(1).filter(X6).filter((i) => i.rel === "stylesheet" || i.rel === "preload").map(
      (i) => i.rel === "stylesheet" ? { ...i, rel: "prefetch", as: "style" } : { ...i, rel: "prefetch" }
    )
  );
}
function a0(t, e, n, o, i, u) {
...
function l5({
  ...
  return o ? /* @__PURE__ */ I.createElement(c5, { page: t, matches: o, ...e }) : null;
}
function u5(t) {
...
function c5({
  ...
  let o = A1(), { manifest: i, routeModules: u } = R0(), { basename: m } = j0(), { loaderData: h, matches: v } = o5(), p = I.useMemo(
    () => a0(
      t,
      e,
      v,
...
var T0 = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, F0 = I.forwardRef(
  function({
    ...
    let P = S6(p, { relative: i }), [j, N, F] = s5(
      o,
      g
    ), A = p5(p, {
      replace: m,
    ...
    return j && !L ? /* @__PURE__ */ I.createElement(I.Fragment, null, $, /* @__PURE__ */ I.createElement(l5, { page: P })) : $;
  }
);
F0.displayName = "Link";
var d5 = I.forwardRef(
  function({
    ...
    w5(b) && h === !0, d = _.encodeLocation ? _.encodeLocation(b).pathname : b.pathname, P = g.pathname, j = C && C.navigation && C.navigation.location ? C.navigation.location.pathname : null;
...
var f5 = I.forwardRef(
  ({
    ...
    let _ = y5(), L = _5(h, { relative: p }), R = m.toLowerCase() === "get" ? "get" : "post", d = typeof h == "string" && T0.test(h), P = (j) => {
...
function y5() {
  ...
  return I.useCallback(
    async (o, i = {}) => {
      let { action: u, method: m, encType: h, formData: v, body: p } = K6(
        o,
        e
      );
      if (i.navigate === !1) {
        let x = i.fetcherKey || g5();
...
function o0(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? i0(Object(n), !0).forEach(function(o) {
      b5(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : i0(Object(n)).forEach(function(o) {
...
function k5(t, e, n) {
  const o = t[e], i = t[n];
  if (o !== i) return i - o;
  const u = s0.indexOf(e), m = s0.indexOf(n);
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    if (u) {
      ...
      if ((u.level || 1) > o.level) {
        const m = I2(u, i, e);
        if (e === "html") {
          const h = o.children[o.children.length - 1], v = o0(o0({}, h), {}, {
...
function E1(t) {
  for (var e = 1; e < arguments.length; e++) {
    var n = arguments[e] != null ? arguments[e] : {};
    e % 2 ? l0(Object(n), !0).forEach(function(o) {
      D5(t, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : l0(Object(n)).forEach(function(o) {
      Object.defineProperty(t, o, Object.getOwnPropertyDescriptor(n, o));
    });
  }
  return t;
...
function u3({
  ...
  const i = o || ne, u = Array.isArray(t) ? t : [t], m = E5(u, n || M5), h = M2(() => e ? ee(c0, e) : c0, [e]), v = M2(() => te(h, i), [h, i]), p = m.map((x, b) => v({
    node: x,
    index: b,
    isInline: !1,
    renderNode: v
  ...
  return /* @__PURE__ */ f.jsxs("div", { className: r1.docPageRoot, children: [
    ...
    /* @__PURE__ */ f.jsxs("div", { className: r1.container, children: [
      ...
      /* @__PURE__ */ f.jsxs("article", { className: r1.mainContent, children: [
        /* @__PURE__ */ f.jsx("div", { className: r1.breadcrumbs, children: u && /* @__PURE__ */ f.jsx(w0, { items: u }) }),
