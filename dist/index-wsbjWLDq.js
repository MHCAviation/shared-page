...
import Xt, { useState as G1, useRef as $3, useEffect as _1, useCallback as Zt, useMemo as z3 } from "react";
...
function D6() {
  return $4 || ($4 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function f(O, q, t1, i1, l1, v1, E1, l2) {
      return t1 = v1.ref, O = {
        $$typeof: g,
        type: O,
        key: q,
    ...
    function b(O, q, t1, i1, l1, v1, E1, l2) {
      var a1 = q.children;
      if (a1 !== void 0)
        if (i1)
          if (_(a1)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    n3.Fragment = v, n3.jsx = function(O, q, t1, i1, l1) {
      var v1 = 1e4 > S.recentlyCreatedOwnerStacks++;
      return b(
        O,
        q,
        t1,
...
var R4;
function F6() {
  return R4 || (R4 = 1, process.env.NODE_ENV === "production" ? R3.exports = R6() : R3.exports = D6()), R3.exports;
}
var I = F6(), q6 = Object.defineProperty, N6 = Object.defineProperties, U6 = Object.getOwnPropertyDescriptors, B3 = Object.getOwnPropertySymbols, x9 = Object.prototype.hasOwnProperty, L9 = Object.prototype.propertyIsEnumerable, F0 = (r, e, t) => e in r ? q6(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t, x1 = (r, e) => {
  for (var t in e || (e = {})) x9.call(e, t) && F0(r, t, e[t]);
  if (B3) for (var t of B3(e)) L9.call(e, t) && F0(r, t, e[t]);
  return r;
}, q1 = (r, e) => N6(r, U6(e)), j9 = (r, e) => {
  var t = {};
  ...
  constructor() {
    G(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new W6() : new z6();
  }
  requestAnimationFrame(r) {
...
}, L1 = typeof window < "u" && typeof window.document < "u", j0 = new Uint8Array([80, 75, 3, 4]), H6 = ["v", "ip", "op", "layers", "fr", "w", "h"], M9 = "0.42.0", O9 = "@lottiefiles/dotlottie-web", V6 = 0.75, G6 = (() => {
  ...
  return function(t = {}) {
    ...
    function v0(s, o, l, h, p) {
      ...
      return Q2(s, function(...N1) {
        ...
        for (var y1 = 0; y1 < R; ++y1) F[y1] = o[y1 + 2].toWireType(r1, N1[y1]), K.push(F[y1]);
        if (N1 = h(...K), x) l0(r1);
        else for (y1 = P ? 1 : 2; y1 < o.length; y1++) {
...
` + h.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var Rt = { c: (s, o, l, h) => B(`Assertion failed: ${s ? a1(L, s) : ""}, at: ` + [o ? o ? a1(L, o) : "" : "unknown filename", l, h ? h ? a1(L, h) : "" : "unknown function"]), d: () => c0(), p: (s, o, l) => {
      ...
      h2([s], w, (P) => {
        var x = {};
        return p.forEach(($, R) => {
          var F = P[R], K = $.hb, r1 = $.ib, N1 = P[R + p.length], m1 = $.ob, y1 = $.qb;
          x[$.eb] = { read: (H1) => F.fromWireType(K(r1, H1)), write: (H1, e3) => {
            var U1 = [];
            m1(y1, H1, N1.toWireType(U1, e3)), l0(U1);
          } };
      ...
      f0(N1, function() {
        ...
        m1.prototype = e3;
        var U1 = new ft(F, m1, e3, r1, y1, w, x, R);
        if (U1.Ja) {
          var t3;
          (t3 = U1.Ja).Ya != null || (t3.Ya = []), U1.Ja.Ya.push(U1);
        }
        return y1 = new K2(F, U1, !0, !1, !1), t3 = new K2(F + "*", U1, !1, !1, !1), H1 = new K2(F + " const*", U1, !1, !0, !1), f4[s] = { pointerType: t3, bb: H1 }, m4(N1, m1), [y1, t3, H1];
      });
    }, t: (s, o, l, h, p, w) => {
      var P = m0(o, l);
      p = P1(h, p), h2([], [s], (x) => {
    ...
    function O4() {
      ...
      if (!(0 < Q)) {
        ...
        v1(S), 0 < Q || (i.setStatus ? (i.setStatus("Running..."), setTimeout(() => {
...
function F4(r) {
  return H6.every((e) => Object.prototype.hasOwnProperty.call(r, e));
}
function q4(r) {
...
function E2() {
  return 1 + ((L1 ? window.devicePixelRatio : 1) - 1) * V6;
}
function k9(r) {
  let e = r.getBoundingClientRect();
  return e.top >= 0 && e.left >= 0 && e.bottom <= (window.innerHeight || document.documentElement.clientHeight) && e.right <= (window.innerWidth || document.documentElement.clientWidth);
}
var M0 = (r, e) => r === "reverse" ? e.Mode.Reverse : r === "bounce" ? e.Mode.Bounce : r === "reverse-bounce" ? e.Mode.ReverseBounce : e.Mode.Forward, K6 = (r, e) => r === "contain" ? e.Fit.Contain : r === "cover" ? e.Fit.Cover : r === "fill" ? e.Fit.Fill : r === "fit-height" ? e.Fit.FitHeight : r === "fit-width" ? e.Fit.FitWidth : e.Fit.None, X6 = (r, e) => {
  ...
  var t, n;
  return r ? { align: X6((t = r.align) != null ? t : [0.5, 0.5], e), fit: K6((n = r.fit) != null ? n : "contain", e) } : e.createDefaultLayout();
}, A9 = class h1 {
  constructor(e) {
  ...
  setBackgroundColor(e) {
    this._dotLottieCore !== null && (L1 && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = e : this._dotLottieCore.setConfig(q1(x1({}, this._dotLottieCore.config()), { backgroundColor: Q6(e) })), this._backgroundColor = e);
  }
  setLoop(e) {
...
var Z6 = A9, e5 = class {
  ...
  getWorker(r) {
    return this._workers.has(r) || this._workers.set(r, new t5()), this._workers.get(r);
  }
...
G(W4, "_workerManager", new r5()), G(W4, "_wasmUrl", "");
var n5 = ({ animationId: r, autoplay: e, backgroundColor: t, className: n, createDotLottie: i, data: a, dotLottieRefCallback: u, layout: c, loop: d, mode: f, playOnHover: b, renderConfig: y, segment: C, speed: g, src: E, style: v, themeData: k, themeId: T, useFrameInterpolation: A, workerId: L, ...N }) => {
  ...
  p1.current = u, W.current = J, S.current = I1, _1(() => {
...
}, i5 = (r) => new Z6(r), s5 = (r) => I.jsx(n5, { ...r, createDotLottie: i5 });
const gi = ({
  ...
  return /* @__PURE__ */ I.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ I.jsx("h1", { style: { ...d5, color: i }, children: "404" }),
        /* @__PURE__ */ I.jsx("p", { style: f5, children: r }),
        /* @__PURE__ */ I.jsxs("form", { style: o5, onSubmit: b, children: [
          /* @__PURE__ */ I.jsx(
            "input",
            {
              type: "text",
  ...
  color: "#4a5568",
  marginTop: "1rem"
}, p5 = "_banner_r16pf_5", m5 = "_bannerOverlay_r16pf_25", v5 = "_bannerContent_r16pf_43", y5 = "_bannerTitle_r16pf_61", g5 = "_bannerDescription_r16pf_73", _5 = "_searchBar_r16pf_85", w5 = "_searchInput_r16pf_95", b5 = "_searchIcon_r16pf_141", d2 = {
  banner: p5,
  bannerOverlay: m5,
  bannerContent: v5,
  bannerTitle: y5,
  bannerDescription: g5,
  searchBar: _5,
  searchInput: w5,
  searchIcon: b5
}, T9 = ({
...
function $e(r, e, t, n, i = {}, a = {}) {
  ...
  return u.enabled ? g.pipe(
    Ar(
      C3(
        import("./stegaEncodeSourceMap-DtCiJg2q.js").then(function(E) {
...
const s7 = (r, e) => e.reduce((t, n) => (typeof r[n] > "u" || (t[n] = r[n]), t), {}), Ke = le(() => import("./browser-CKu_7Oc6.js").then((r) => r.b)).pipe(
  j1(({ default: r }) => r),
  Tr(1)
);
function Xe() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function T(S) {
        ...
        return i1 && D.push("flip=" + i1), v.forEach(function(l1) {
          var v1 = l1[0], E1 = l1[1];
          typeof S[v1] < "u" ? D.push(E1 + "=" + encodeURIComponent(S[v1])) : typeof S[E1] < "u" && D.push(E1 + "=" + encodeURIComponent(S[E1]));
      ...
      function A(S, M) {
        ...
        if (w1 > o1) {
          ...
          var v1 = D.width, E1 = Math.round(v1 / o1), l2 = Math.max(0, Math.round(D.left)), a1 = Math.round((B.bottom - B.top) / 2 + B.top), b1 = Math.max(0, Math.round(a1 - E1 / 2));
...
const j7 = /* @__PURE__ */ $6(L7), s4 = E7({
  ...
  const [n, i] = G1(() => new URLSearchParams(window.location.search).get("search") || ""), [a, u] = G1(e), [c, d] = G1(!1), [f, b] = G1(null);
  _1(() => {
...
`, Ci = ({ slug: r }) => {
  ...
  }, [r]), e) return /* @__PURE__ */ I.jsx("div", { className: g1.loading, children: "Loading…" });
  if (n || !a) return /* @__PURE__ */ I.jsx("div", { className: g1.error, children: n });
  const { title: f, authorName: b, authorImage: y, publishedAt: C, tableOfContents: g, body: E } = a, v = C ? new Date(C).toLocaleDateString(void 0, {
    ...
    types: {
      ...
      reference: ({ value: L }) => {
        ...
        return N ? /* @__PURE__ */ I.jsx("h3", { className: g1.sectionReferenceLink, id: N.slug, children: N.title }) : null;
      },
      table: ({ value: L }) => {
        var z;
  ...
  return /* @__PURE__ */ I.jsxs("div", { className: g1.docPageRoot, children: [
    /* @__PURE__ */ I.jsx(
      "div",
      {
        className: g1.docPageWrapper,
        style: {
          "--banner-image": "url('https://images.unsplash.com/photo-1507812984078-917a274065be?q=80&w=1364&auto=format&fit=crop&ixlib=rb-4.1.0')"
        },
        children: /* @__PURE__ */ I.jsx(
    ...
    /* @__PURE__ */ I.jsxs("div", { className: g1.container, children: [
      /* @__PURE__ */ I.jsx("aside", { className: g1.stickySidebar, children: /* @__PURE__ */ I.jsxs("div", { className: g1.sidebarInner, children: [
      ...
      /* @__PURE__ */ I.jsxs("article", { className: g1.mainContent, children: [
        /* @__PURE__ */ I.jsxs("nav", { className: g1.breadcrumbs, children: [
          /* @__PURE__ */ I.jsx("a", { href: "/", children: "All Collections" }),
          " > ",
          /* @__PURE__ */ I.jsx("span", { children: f })
        ] }),
        /* @__PURE__ */ I.jsx("h1", { className: g1.pageTitle, children: f }),
        /* @__PURE__ */ I.jsxs("div", { className: g1.metaInfo, children: [
          y ? /* @__PURE__ */ I.jsx(
            "img",
            {
              src: y,
              alt: b || "Author",
              className: g1.authorImage
            }
          ) : /* @__PURE__ */ I.jsx("div", { className: g1.authorPlaceholder }),
          /* @__PURE__ */ I.jsxs("div", { children: [
            b && /* @__PURE__ */ I.jsxs("div", { className: g1.authorName, children: [
              "Written by ",
              b
            ] }),
            v && /* @__PURE__ */ I.jsxs("div", { className: g1.publishedDate, children: [
              "Updated ",
              v
            ] })
          ] })
        ] }),
        k.length > 0 && /* @__PURE__ */ I.jsxs("section", { className: g1.tocInContent, children: [
          /* @__PURE__ */ I.jsx("h2", { children: "Table Of Content" }),
          /* @__PURE__ */ I.jsx("ul", { children: k.map((L) => /* @__PURE__ */ I.jsx("li", { className: g1.tocItem, children: /* @__PURE__ */ I.jsx("a", { href: `#${L.slug.replace(/^#+/, "")}`, children: L.title }) }, L._id)) })
        ] }),
        /* @__PURE__ */ I.jsx("section", { className: g1.bodyContent, children: /* @__PURE__ */ I.jsx(N3, { value: E, components: A }) })
      ] })
    ] })
  ] });
};
